...
export default {
    ...
    methods: {
        loadMore(){
            ...
            this.busy = true;
            axios({
                 url:`http://www.mei.com/appapi/silo/eventForH5?categoryId=women&pageIndex=${this.current}&timestamp=1550136840985&summary=b6f5469b518994f622b87c676ec42c4b&platform_code=H5`
            }).then(result=>{
