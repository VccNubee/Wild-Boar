...
export default {
    ...
    methods: {
        loadMore(){
            ...
            this.busy = true;
            axios({
                 url:`http://www.mei.com/appapi/silo/eventForH5?categoryId=cosmetics&pageIndex=${this.current}&timestamp=1550137034727&summary=89cffc0a41abac1da23e1e8dcb9b0a77&platform_code=H5`
            }).then(result=>{
