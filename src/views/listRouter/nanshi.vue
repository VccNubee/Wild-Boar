...
export default {
    ...
    methods: {
        loadMore(){
            ...
            this.busy = true;
            axios({
                 url:`http://www.mei.com/appapi/silo/eventForH5?categoryId=men&pageIndex=${this.current}&timestamp=1550136904347&summary=86db41269c6cf26728adb784d688d6d6&platform_code=H5`
            }).then(result=>{
